...
def calculate_bljs_divergence(config):
    config_output_path = config['output']['output_path']
    folder_path = os.path.join(config_output_path, 'Structural-properties-metrics', '3D', 'Bond-length-merge')
    ...
    output_path = os.path.join(config_output_path, 'Structural-properties-metrics', '3D', 'JSD-of-bond-length')
